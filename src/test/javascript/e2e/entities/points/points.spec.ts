...
describe('Points e2e test', () => {
  ...
  it('should load Points', async () => {
    ...
    expect(await pointsComponentsPage.getTitle()).to.eq('blackshieldApp.points.home.title');
  });
  ...
  it('should load create Points page', async () => {
    ...
    expect(await pointsUpdatePage.getPageTitle()).to.eq('blackshieldApp.points.home.createOrEditLabel');
  ...
  it('should create and save Points', async () => {
    ...
    await promise.all([
      ...
      pointsUpdatePage.setWaterInput('5'),
    ...
    expect(await pointsUpdatePage.getWaterInput()).to.eq('5', 'Expected water value to be equals to 5');
  ...
  it('should delete last Points', async () => {
    ...
    expect(await pointsDeleteDialog.getDialogTitle()).to.eq('blackshieldApp.points.delete.question');
