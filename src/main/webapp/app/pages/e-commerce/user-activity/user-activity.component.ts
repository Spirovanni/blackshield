...
import { UserActivityData, UserActive } from '../../../shared/@core/data/user-activity';
        ...
        <ul class="user-activity-list">
          <li *ngFor="let item of userActivity">
            ...
            <div class="visited-percentages">
              ...
              <div class="delta value" [class.up]="item.deltaUp" [class.down]="!item.deltaUp">{{ item.newVisits }}%</div>
            </div>
          </li>
        </ul>
      </nb-card-body>
